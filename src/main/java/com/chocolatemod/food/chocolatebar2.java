...
public class chocolatebar2 extends ItemFood {
	...
	public static final String[] field_94595_b = new String[]{"default_fruity", "dark_fruity", "light_fruity", "white_fruity", "extradark_fruity", "default_nuts", "dark_nuts", "light_nuts", "white_nuts", "extradark_nuts", "default_minty", "dark_minty", "light_minty", "white_minty", "extradark_minty"};
