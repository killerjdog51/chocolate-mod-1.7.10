...
public class lightChocolatePie extends Item {
	private Block field_150935_a;
	private static final String __OBFID = "CL_00001773";

	public lightChocolatePie(Block p_i45329_1_) {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon("killerjdog51:pie_light_chocolate");
	}
}