...
public class extraDarkChocolatePie extends Item {
	private Block field_150935_a;
	private static final String __OBFID = "CL_00001773";

	public extraDarkChocolatePie(Block p_i45329_1_) {
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
		...
		{
			par2EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ItemRegistry.piePan, 1));
		}
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon("killerjdog51:pie_extradark_chocolate");
	}
}