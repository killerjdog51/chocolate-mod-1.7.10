...
public class extradarkchocolatecake extends Item {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon("killerjdog51:extradarkchocolatecake");
	}
