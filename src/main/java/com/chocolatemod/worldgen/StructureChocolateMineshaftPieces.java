...
public class StructureChocolateMineshaftPieces
{
    /** List of contents that can generate in Mineshafts. */
    public static final WeightedRandomChestContent[] mineshaftChestContents = new WeightedRandomChestContent[] {new WeightedRandomChestContent(ItemRegistry.chocolateIngots, 0, 1, 5, 10), new WeightedRandomChestContent(ItemRegistry.chocolateIngots, 1, 1, 3, 5), new WeightedRandomChestContent(ItemRegistry.chocolateIngots, 2, 1, 3, 5), new WeightedRandomChestContent(ItemRegistry.chocolateIngots, 3, 1, 3, 5), new WeightedRandomChestContent(Items.redstone, 0, 4, 9, 5), new WeightedRandomChestContent(Items.dye, 4, 4, 9, 5), new WeightedRandomChestContent(Items.diamond, 0, 1, 2, 3), new WeightedRandomChestContent(Items.coal, 0, 3, 8, 10), new WeightedRandomChestContent(FoodRegistry.chocolatebar1, 0, 1, 3, 15), new WeightedRandomChestContent(Tools.ChocolatePickaxe, 0, 1, 1, 1), new WeightedRandomChestContent(Item.getItemFromBlock(Blocks.rail), 0, 4, 8, 1), new WeightedRandomChestContent(crops.strawberry, 0, 2, 4, 10), new WeightedRandomChestContent(crops.mintSeeds, 0, 2, 4, 10), new WeightedRandomChestContent(Items.saddle, 0, 1, 1, 3), new WeightedRandomChestContent(Items.iron_horse_armor, 0, 1, 1, 1),  new WeightedRandomChestContent(FoodRegistry.goldchocolatebar1, 0, 1, 2, 3),  new WeightedRandomChestContent(FoodRegistry.goldchocolatebar2, 0, 1, 1, 1)};
    private static final String __OBFID = "CL_00000444";

    public static void registerStructurePieces()
    {
        MapGenChocolateStructureIO.func_143031_a(StructureChocolateMineshaftPieces.Corridor.class, "MSCorridor");
        MapGenChocolateStructureIO.func_143031_a(StructureChocolateMineshaftPieces.Cross.class, "MSCrossing");
        MapGenChocolateStructureIO.func_143031_a(StructureChocolateMineshaftPieces.Room.class, "MSRoom");
        MapGenChocolateStructureIO.func_143031_a(StructureChocolateMineshaftPieces.Stairs.class, "MSStairs");
    }

    private static ChocolateStructureComponent getRandomComponent(List p_78815_0_, Random p_78815_1_, int p_78815_2_, int p_78815_3_, int p_78815_4_, int p_78815_5_, int p_78815_6_)
    {
        ...
        if (j1 >= 80)
        {
            structureboundingbox = StructureChocolateMineshaftPieces.Cross.findValidPlacement(p_78815_0_, p_78815_1_, p_78815_2_, p_78815_3_, p_78815_4_, p_78815_5_);

            if (structureboundingbox != null)
            {
                return new StructureChocolateMineshaftPieces.Cross(p_78815_6_, p_78815_1_, structureboundingbox, p_78815_5_);
            }
        }
        else if (j1 >= 70)
        {
            structureboundingbox = StructureChocolateMineshaftPieces.Stairs.findValidPlacement(p_78815_0_, p_78815_1_, p_78815_2_, p_78815_3_, p_78815_4_, p_78815_5_);

            if (structureboundingbox != null)
            {
                return new StructureChocolateMineshaftPieces.Stairs(p_78815_6_, p_78815_1_, structureboundingbox, p_78815_5_);
            }
        }
        else
        {
            structureboundingbox = StructureChocolateMineshaftPieces.Corridor.findValidPlacement(p_78815_0_, p_78815_1_, p_78815_2_, p_78815_3_, p_78815_4_, p_78815_5_);

            if (structureboundingbox != null)
            {
                return new StructureChocolateMineshaftPieces.Corridor(p_78815_6_, p_78815_1_, structureboundingbox, p_78815_5_);
            }
        }
    ...
    private static ChocolateStructureComponent getNextMineShaftComponent(ChocolateStructureComponent p_78817_0_, List p_78817_1_, Random p_78817_2_, int p_78817_3_, int p_78817_4_, int p_78817_5_, int p_78817_6_, int p_78817_7_)
    {
        if (p_78817_7_ > 8)
        {
            return null;
        ...
        {
            ChocolateStructureComponent structurecomponent1 = getRandomComponent(p_78817_1_, p_78817_2_, p_78817_3_, p_78817_4_, p_78817_5_, p_78817_6_, p_78817_7_ + 1);
    ...
    public static class Corridor extends ChocolateStructureComponent
        {
            ...
            public static StructureBoundingBox findValidPlacement(List p_74954_0_, Random p_74954_1_, int p_74954_2_, int p_74954_3_, int p_74954_4_, int p_74954_5_)
            {
                ...
                for (i1 = p_74954_1_.nextInt(3) + 2; i1 > 0; --i1)
                {
                    ...
                    if (ChocolateStructureComponent.findIntersecting(p_74954_0_, structureboundingbox) == null)
                    {
                        break;
                    }
                }
            ...
            public void buildComponent(ChocolateStructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
            {
                ...
                switch (this.coordBaseMode)
                {
                    case 0:
                        if (j <= 1)
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.maxZ + 1, this.coordBaseMode, i);
                        }
                        else if (j == 2)
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.maxZ - 3, 1, i);
                        }
                        else
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.maxZ - 3, 3, i);
                        }
                    ...
                    case 1:
                        if (j <= 1)
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, i);
                        }
                        else if (j == 2)
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.minZ - 1, 2, i);
                        }
                        else
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.maxZ + 1, 0, i);
                        }
                    ...
                    case 2:
                        if (j <= 1)
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.minZ - 1, this.coordBaseMode, i);
                        }
                        else if (j == 2)
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.minZ, 1, i);
                        }
                        else
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.minZ, 3, i);
                        }
                    ...
                    case 3:
                        if (j <= 1)
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, i);
                        }
                        else if (j == 2)
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.minZ - 1, 2, i);
                        }
                        else
                        {
                            StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + p_74861_3_.nextInt(3), this.boundingBox.maxZ + 1, 0, i);
                        }
                }
                ...
                if (i < 8)
                {
                    ...
                    if (this.coordBaseMode != 2 && this.coordBaseMode != 0)
                    {
                        for (k = this.boundingBox.minX + 3; k + 3 <= this.boundingBox.maxX; k += 5)
                        {
                            ...
                            if (l == 0)
                            {
                                StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, k, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i + 1);
                            }
                            else if (l == 1)
                            {
                                StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, k, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i + 1);
                            }
                        }
                    }
                    else
                    {
                        for (k = this.boundingBox.minZ + 3; k + 3 <= this.boundingBox.maxZ; k += 5)
                        {
                            ...
                            if (l == 0)
                            {
                                StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY, k, 1, i + 1);
                            }
                            else if (l == 1)
                            {
                                StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY, k, 3, i + 1);
                            }
                        }
                    }
                }
            ...
            public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                ...
                else
                {
                    ...
                    {
                        k = 2 + j * 5;
                        this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 0, k, 0, 1, k, BlockRegistry.cocoaFence, Blocks.air, false);
                        this.fillWithBlocks(p_74875_1_, p_74875_3_, 2, 0, k, 2, 1, k, BlockRegistry.cocoaFence, Blocks.air, false);

                        if (p_74875_2_.nextInt(4) == 0)
                        {
                            this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 2, k, 0, 2, k, BlockRegistry.CocoaPlanks, Blocks.air, false);
                            this.fillWithBlocks(p_74875_1_, p_74875_3_, 2, 2, k, 2, 2, k, BlockRegistry.CocoaPlanks, Blocks.air, false);
                        }
                        else
                        {
                            this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 2, k, 2, 2, k, BlockRegistry.CocoaPlanks, Blocks.air, false);
                        }
                    ...
                    for (j = 0; j <= 2; ++j)
                    {
                        for (k = 0; k <= i; ++k)
                        {
                            ...
                            {
                                byte b1 = -1;
                                this.placeBlockAtCurrentPosition(p_74875_1_, BlockRegistry.CocoaPlanks, 0, j, b1, k, p_74875_3_);
                            }
                        }
                    }
    ...
    public static class Cross extends ChocolateStructureComponent
        {
            ...
            public static StructureBoundingBox findValidPlacement(List p_74951_0_, Random p_74951_1_, int p_74951_2_, int p_74951_3_, int p_74951_4_, int p_74951_5_)
            {
                ...
                return ChocolateStructureComponent.findIntersecting(p_74951_0_, structureboundingbox) != null ? null : structureboundingbox;
            }
            ...
            public void buildComponent(ChocolateStructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
            {
                ...
                {
                    case 0:
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i);
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, 1, i);
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, 3, i);
                        break;
                    case 1:
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i);
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i);
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, 1, i);
                        break;
                    case 2:
                ...
                if (this.isMultipleFloors)
                {
                    ...
                    {
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ - 1, 2, i);
                    }

                    if (p_74861_3_.nextBoolean())
                    {
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, 1, i);
                    }

                    if (p_74861_3_.nextBoolean())
                    {
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, 3, i);
                    }

                    if (p_74861_3_.nextBoolean())
                    {
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.maxZ + 1, 0, i);
                    }
                }
            }
            ...
            public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                ...
                else
                {
                    ...
                    this.fillWithBlocks(p_74875_1_, p_74875_3_, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.minX + 1, this.boundingBox.maxY, this.boundingBox.minZ + 1, BlockRegistry.CocoaPlanks, Blocks.air, false);
                    this.fillWithBlocks(p_74875_1_, p_74875_3_, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 1, this.boundingBox.minX + 1, this.boundingBox.maxY, this.boundingBox.maxZ - 1, BlockRegistry.CocoaPlanks, Blocks.air, false);
                    this.fillWithBlocks(p_74875_1_, p_74875_3_, this.boundingBox.maxX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.maxX - 1, this.boundingBox.maxY, this.boundingBox.minZ + 1, BlockRegistry.CocoaPlanks, Blocks.air, false);
                    this.fillWithBlocks(p_74875_1_, p_74875_3_, this.boundingBox.maxX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 1, this.boundingBox.maxX - 1, this.boundingBox.maxY, this.boundingBox.maxZ - 1, BlockRegistry.CocoaPlanks, Blocks.air, false);
                    ...
                    for (int i = this.boundingBox.minX; i <= this.boundingBox.maxX; ++i)
                    {
                        for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j)
                        {
                            ...
                            {
                                this.placeBlockAtCurrentPosition(p_74875_1_, BlockRegistry.CocoaPlanks, 0, i, this.boundingBox.minY - 1, j, p_74875_3_);
                            }
                        }
                    }
    ...
    public static class Room extends ChocolateStructureComponent
        {
            ...
            public void buildComponent(ChocolateStructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
            {
                ...
                for (j = 0; j < this.boundingBox.getXSize(); j += 4)
                {
                    ...
                    structurecomponent1 = StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + j, this.boundingBox.minY + p_74861_3_.nextInt(k) + 1, this.boundingBox.minZ - 1, 2, i);
                ...
                for (j = 0; j < this.boundingBox.getXSize(); j += 4)
                {
                    ...
                    structurecomponent1 = StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + j, this.boundingBox.minY + p_74861_3_.nextInt(k) + 1, this.boundingBox.maxZ + 1, 0, i);
                ...
                for (j = 0; j < this.boundingBox.getZSize(); j += 4)
                {
                    ...
                    structurecomponent1 = StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74861_3_.nextInt(k) + 1, this.boundingBox.minZ + j, 1, i);
                ...
                for (j = 0; j < this.boundingBox.getZSize(); j += 4)
                {
                    ...
                    structurecomponent1 = StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74861_3_.nextInt(k) + 1, this.boundingBox.minZ + j, 3, i);
            ...
            public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                ...
                {
                    this.fillWithBlocks(p_74875_1_, p_74875_3_, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX, this.boundingBox.minY, this.boundingBox.maxZ, BlockRegistry.chocoDirt, Blocks.air, true);
    ...
    public static class Stairs extends ChocolateStructureComponent
        {
            ...
            public static StructureBoundingBox findValidPlacement(List p_74950_0_, Random p_74950_1_, int p_74950_2_, int p_74950_3_, int p_74950_4_, int p_74950_5_)
            {
                ...
                return ChocolateStructureComponent.findIntersecting(p_74950_0_, structureboundingbox) != null ? null : structureboundingbox;
            }
            ...
            public void buildComponent(ChocolateStructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
            {
                ...
                {
                    case 0:
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i);
                        break;
                    case 1:
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, 1, i);
                        break;
                    case 2:
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, i);
                        break;
                    case 3:
                        StructureChocolateMineshaftPieces.getNextMineShaftComponent(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, 3, i);
                }
            }
