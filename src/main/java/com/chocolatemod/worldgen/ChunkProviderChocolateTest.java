...
public class ChunkProviderChocolateTest implements IChunkProvider {
	 ...
	 */
	private MapGenChocolateVillage chocolateVillageGenerator = new MapGenChocolateVillage();
	/**
	 * Holds Mineshaft Generator
	 */
	private MapGenChocolateMineshaft mineshaftGenerator = new MapGenChocolateMineshaft();
    ...
    public MapGenChocolateBridge genNetherBridge = new MapGenChocolateBridge();
...

	{
		...
		chocolateVillageGenerator = (MapGenChocolateVillage) TerrainGen.getModdedMapGen(chocolateVillageGenerator, SCATTERED_FEATURE);
		mineshaftGenerator = (MapGenChocolateMineshaft) TerrainGen.getModdedMapGen(mineshaftGenerator, MINESHAFT);
		scatteredFeatureGenerator = (MapGenScatteredFeature) TerrainGen.getModdedMapGen(scatteredFeatureGenerator, SCATTERED_FEATURE);
		ravineGenerator = TerrainGen.getModdedMapGen(ravineGenerator, RAVINE);
        genNetherBridge = (MapGenChocolateBridge) TerrainGen.getModdedMapGen(genNetherBridge, NETHER_BRIDGE);
	...
	public Chunk provideChunk(int par1, int par2) {
		...
		if (this.mapFeaturesEnabled) {
			...
			this.chocolateVillageGenerator.func_151539_a(this, this.worldObj, par1, par2, ablock);
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		if (this.mapFeaturesEnabled) {
			...
			flag = this.chocolateVillageGenerator.generateStructuresInChunk(this.worldObj, this.rand, par2, par3);
		...
		if (biomegenbase != BiomeGenChocolateBase.chocolateDesert && !flag && this.rand.nextInt(4) == 0
		...
		if (biomegenbase != BiomeGenChocolateBase.chocolateDesert && TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAVA) && !flag && this.rand.nextInt(8) == 0) {
			k1 = k + this.rand.nextInt(16) + 8;
		...
		if (biomegenbase != BiomeGenChocolateBase.chocolateDesert && TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAVA) && !flag && this.rand.nextInt(8) == 0) {
			...
			if (l1 < 63 || this.rand.nextInt(10) == 0) {
				(new WorldGenLakes(LiquidRegistry.ExtraDarkChocolateMilkBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
			}
		}
	...
	public void recreateStructures(int par1, int par2) {
		if (this.mapFeaturesEnabled) {
			...
			this.chocolateVillageGenerator.func_151539_a(this, this.worldObj, par1, par2, (Block[]) null);
