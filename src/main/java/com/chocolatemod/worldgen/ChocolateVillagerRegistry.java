 ...
 *
 */
public class ChocolateVillagerRegistry
{
    private static final ChocolateVillagerRegistry INSTANCE = new ChocolateVillagerRegistry();
    ...
    public interface IVillageCreationHandler
    {
         ...
         * @param p5
         */
        Object buildComponent(com.chocolatemod.worldgen.StructureChocolateVillagePieces.PieceWeight p_75083_1_, com.chocolatemod.worldgen.StructureChocolateVillagePieces.Start p_75083_0_, @SuppressWarnings("rawtypes") List pieces, Random random, int p1,
    ...
    public static ChocolateVillagerRegistry instance()
    {
        return INSTANCE;
    }
    ...
    public static Object getVillageComponent(com.chocolatemod.worldgen.StructureChocolateVillagePieces.PieceWeight p_75083_1_, com.chocolatemod.worldgen.StructureChocolateVillagePieces.Start p_75083_0_, @SuppressWarnings("rawtypes") List pieces, Random random,
            int p1, int p2, int p3, int p4, int p5)
    {
        return instance().villageCreationHandlers.get(p_75083_1_.villagePieceClass).buildComponent(p_75083_1_, p_75083_0_, pieces, random, p1, p2, p3, p4, p5);
    }
