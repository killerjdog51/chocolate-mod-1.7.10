...
public abstract class ChocolateStructureComponent
{
    ...
    public ChocolateStructureComponent() {}

    protected ChocolateStructureComponent(int p_i2091_1_)
    {
    ...
    {
        if (MapGenChocolateStructureIO.func_143036_a(this) == null) // Friendlier error then the Null Stirng error below.
        {
        ...
        nbttagcompound.setString("id", MapGenChocolateStructureIO.func_143036_a(this));
     ...
     */
    public static ChocolateStructureComponent findIntersecting(List p_74883_0_, StructureBoundingBox p_74883_1_)
    {
        ...
        do
        {
            ...
            structurecomponent = (ChocolateStructureComponent)iterator.next();
        }
     ...
     */
    protected void fillWithRandomizedBlocks(World p_74882_1_, StructureBoundingBox p_74882_2_, int p_74882_3_, int p_74882_4_, int p_74882_5_, int p_74882_6_, int p_74882_7_, int p_74882_8_, boolean p_74882_9_, Random p_74882_10_, ChocolateStructureComponent.BlockSelector p_74882_11_)
    {
