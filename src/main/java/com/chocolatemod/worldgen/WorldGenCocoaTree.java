				...
				if (isSoil && y < 256 - l - 1) {
					...
					for (j2 = 0; j2 < l; ++j2) {
						...
						if (block1.isAir(world, k3, k2, l1) || block1.isLeaves(world, k3, k2, l1)) {
							this.setBlockAndNotifyAdequately(world, k3, k2, l1, PlantRegistry.oldCocoaLog, 0);
							i2 = k2;
						}
					}
						...
						for (l2 = k2; l2 < l && l3 > 0; --l3) {
							if (l2 >= 1) {
								...
								if (block2.isAir(world, k3, i3, l1) || block2.isLeaves(world, k3, i3, l1)) {
									this.setBlockAndNotifyAdequately(world, k3, i3, l1, PlantRegistry.oldCocoaLog, 0);
									i2 = i3;
								}
							}
