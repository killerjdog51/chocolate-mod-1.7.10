...
public class BlockSmallChocolateBrickWall extends BlockWall {
	...
	public static final String[] field_150141_b = new String[]{"small", "dark_small", "light_small", "white_small", "extradark_small"};
	...
	public boolean canConnectWallTo(IBlockAccess blockacc, int x, int y, int z) {
		...
		if (l != Blocks.fence_gate && l != Blocks.fence
				&& l != BlockRegistry.chocolateWall && l != BlockRegistry.chocolateBrickWall && l != BlockRegistry.caramelWall && l != BlockRegistry.chocoCobbleStoneWall   && l != this) {
