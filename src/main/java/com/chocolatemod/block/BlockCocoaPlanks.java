...
public class BlockCocoaPlanks extends Block{
	...
	public static final String[] field_150142_a = new String[] {"cocoa", "chocolate", "dark", "light", "white", "extradark"};
    public static final String[] field_150141_b = new String[] {"cocoa", "chocolate", "dark", "light", "white", "extradark"};
    @SideOnly(Side.CLIENT)
    private IIcon[] field_150143_M;
    private static final String __OBFID = "CL_00000318";

    public BlockCocoaPlanks()
    {
        super(Material.wood);
