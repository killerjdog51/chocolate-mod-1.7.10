...
public class BlockChocoSand extends BlockFalling {
	public static final String[] field_150142_a = new String[]{"white", "dark", "light", "default", "extradark"};
	public static final String[] field_150141_b = new String[]{"white", "dark", "light", null, "extradark"};
