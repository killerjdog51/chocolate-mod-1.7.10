...
public class BlockChocolateBrickWall extends BlockWall {
	...
	public static final String[] field_150141_b = new String[]{null, "dark", "light", "white", "extradark"};
	...
	public boolean canConnectWallTo(IBlockAccess blockacc, int x, int y, int z) {
		...
		if (l != Blocks.fence_gate && l != Blocks.fence
				&& l != BlockRegistry.chocolateWall && l != BlockRegistry.caramelWall && l != BlockRegistry.chocolateSmallBrickWall && l != BlockRegistry.chocoCobbleStoneWall   && l != this) {
