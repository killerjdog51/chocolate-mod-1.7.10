...
public class BlockExtraDarkChocolateGlassPane extends BlockPane {
	...
	protected BlockExtraDarkChocolateGlassPane(String p_i45432_1_, String p_i45432_2_, Material p_i45432_3_, boolean p_i45432_4_) {
	...
	public Object idDropped(int par1, Random par2Random, int par3) {
		return !this.field_150099_b ? BlockRegistry.ExtraDarkChocolateGlassPane : super.getItemDropped(par1, par2Random, par3);
	}
