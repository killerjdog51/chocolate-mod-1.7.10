...
public class BlockChocolatePortal extends BlockBreakable
{
	...
	public boolean getPortalSize(World world, int x, int y, int z) {
		BlockChocolatePortal.Size size = new BlockChocolatePortal.Size(world, x, y, z, 1);
		BlockChocolatePortal.Size size1 = new BlockChocolatePortal.Size(world, x, y, z, 2);
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
			...
			} else if (thePlayer.dimension != MainRegistry.DimID) {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, MainRegistry.DimID, new ChocolateTeleporter(thePlayer.mcServer.worldServerForDimension(MainRegistry.DimID)));
			} else {
				thePlayer.timeUntilPortal = 10;
	...
	public static class Size
	{
		...
		public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
		{
			...
			this.field_150863_d = BlockChocolatePortal.field_150001_a[p_i45415_5_][0];
			this.field_150866_c = BlockChocolatePortal.field_150001_a[p_i45415_5_][1];
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					{
						k = this.field_150861_f.posX + j * Direction.offsetX[BlockChocolatePortal.field_150001_a[this.field_150865_b][1]];
						l = this.field_150861_f.posZ + j * Direction.offsetZ[BlockChocolatePortal.field_150001_a[this.field_150865_b][1]];
						...
						if (j == 0)
						{
							block = this.worldObj.getBlock(k + Direction.offsetX[BlockChocolatePortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[BlockChocolatePortal.field_150001_a[this.field_150865_b][0]]);
						...
						{
							block = this.worldObj.getBlock(k + Direction.offsetX[BlockChocolatePortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[BlockChocolatePortal.field_150001_a[this.field_150865_b][1]]);
			...
			{
				j = this.field_150861_f.posX + i * Direction.offsetX[BlockChocolatePortal.field_150001_a[this.field_150865_b][1]];
				k = this.field_150861_f.posY + this.field_150862_g;
				l = this.field_150861_f.posZ + i * Direction.offsetZ[BlockChocolatePortal.field_150001_a[this.field_150865_b][1]];

				if (this.worldObj.getBlock(j, k, l) != BlockRegistry.goldchocolateblock)
				{
		...
		protected boolean getBlockMaterial(Block block){
			return block.getMaterial() == Material.air || block == LiquidRegistry.darkChocolateMilkBlock || block == BlockRegistry.BlockChocolatePortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				for (int l = 0; l < this.field_150862_g; ++l)
				{
					...
					this.worldObj.setBlock(j, i1, k, BlockRegistry.BlockChocolatePortal, this.field_150865_b, 2);
				}
			}
		}
	}
