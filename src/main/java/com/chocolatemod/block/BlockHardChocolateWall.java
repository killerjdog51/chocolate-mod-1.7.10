...
public class BlockHardChocolateWall extends BlockWall {

	public static final String[] field_150142_a = new String[]{"default", "dark", "light", "white", "extradark"};
	public static final String[] field_150141_b = new String[]{"hard", "dark_hard", "light_hard", "white_hard", "extradark_hard"};
	@SideOnly(Side.CLIENT)
	private IIcon[] field_150143_M;

	private Block icon;

	public BlockHardChocolateWall(Block block) {
		super(block);
	...
	public boolean canConnectWallTo(IBlockAccess blockacc, int x, int y, int z) {
		...
		if (l != Blocks.fence_gate && l != Blocks.fence
				&& l != BlockRegistry.caramelWall && l != BlockRegistry.chocolateBrickWall && l != BlockRegistry.chocolateSmallBrickWall && l != BlockRegistry.chocoCobbleStoneWall   && l != this) {
