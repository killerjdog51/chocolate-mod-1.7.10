...
import com.chocolatemod.hooks.MintHooks;
...
public class BlockMintGrass extends BlockBush implements IGrowable, IShearable
{
    @SideOnly(Side.CLIENT)
    private IIcon[] field_149870_b;
    private static final String __OBFID = "CL_00000321";

    protected BlockMintGrass()
    {
        super(Material.vine);
        float f = 0.4F;
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int meta, int fortune)
    {
        ...
        ItemStack seed = MintHooks.getGrassSeed(world);
