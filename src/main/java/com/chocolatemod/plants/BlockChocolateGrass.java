...
import com.chocolatemod.hooks.ChocolateHooks;
...
public class BlockChocolateGrass extends BlockBush implements IGrowable, IShearable
{
    @SideOnly(Side.CLIENT)
    private IIcon[] field_149870_b;
    private static final String __OBFID = "CL_00000321";

    protected BlockChocolateGrass()
    {
        super(Material.vine);
        float f = 0.4F;
    ...
    {
        return block == Blocks.grass || block == Blocks.dirt || block == Blocks.farmland || block == BlockRegistry.chocoGrass || block == BlockRegistry.chocoDirt;
    }
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int meta, int fortune)
    {
        ...
        ItemStack seed = ChocolateHooks.getGrassSeed(world);
