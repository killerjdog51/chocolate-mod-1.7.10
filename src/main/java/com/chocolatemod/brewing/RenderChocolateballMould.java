...
public class RenderChocolateballMould implements ISimpleBlockRenderingHandler {
	@Override
	...
	public boolean renderWorldBlock(IBlockAccess world, int i, int j, int k, Block block, int modelId, RenderBlocks renderer) {
		...
		IIcon icon1 = BlockChocolateBallMould.ChocolateMouldTex[0];
		...
		IIcon icon2 = BlockChocolateBallMould.ChocolateMouldLiquidTex[0];
		...
		switch (meta) {
			...
			case 3:
			case 4:
				icon2 = BlockChocolateBallMould.ChocolateMouldLiquidTex[0];
				break;
			case 5:
				icon2 = BlockChocolateBallMould.ChocolateMouldLiquidTex[1];
				break;
