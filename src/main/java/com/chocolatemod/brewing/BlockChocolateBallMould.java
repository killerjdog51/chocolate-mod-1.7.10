...
public class BlockChocolateBallMould extends Block {
	public static IIcon[] ChocolateMouldTex;
	public static IIcon[] ChocolateMouldLiquidTex;

	public BlockChocolateBallMould() {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		ChocolateMouldTex[0] = reg.registerIcon("killerjdog51:ChocolateBallMould_top2");
		ChocolateMouldTex[1] = reg.registerIcon("minecraft:furnace_top");
		ChocolateMouldTex[2] = reg.registerIcon("minecraft:furnace_side");

		ChocolateMouldLiquidTex[0] = reg.registerIcon("killerjdog51:block_ballmouldchocolate2");
		ChocolateMouldLiquidTex[1] = reg.registerIcon("killerjdog51:block_ballmouldchocolateready2");
	...
	public int getRenderType() {
		return brewing.chocolateBallMouldRenderID;
	}
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer player, int par6, float par7, float par8, float par9) {
		if (world.isRemote) {
			...
			if (itemstack == null) {
				...
				if (meta == 5) {
					ItemStack itemstack1 = new ItemStack(FoodRegistry.chocolateball1, 4, 0);
