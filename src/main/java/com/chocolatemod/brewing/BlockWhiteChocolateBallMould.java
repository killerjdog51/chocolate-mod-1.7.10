...
public class BlockWhiteChocolateBallMould extends Block {
	public static IIcon[] WhiteChocolateMouldTex;
	public static IIcon[] WhiteChocolateMouldLiquidTex;

	public BlockWhiteChocolateBallMould() {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister reg) {
		WhiteChocolateMouldTex = new IIcon[3];
		WhiteChocolateMouldLiquidTex = new IIcon[2];

		WhiteChocolateMouldTex[0] = reg.registerIcon("killerjdog51:ChocolateBallMould_top2");
		WhiteChocolateMouldTex[1] = reg.registerIcon("minecraft:furnace_top");
		WhiteChocolateMouldTex[2] = reg.registerIcon("minecraft:furnace_side");

		WhiteChocolateMouldLiquidTex[0] = reg.registerIcon("killerjdog51:block_ballmouldwhitechocolate2");
		WhiteChocolateMouldLiquidTex[1] = reg.registerIcon("killerjdog51:block_ballmouldwhitechocolateready2");
	...
	public IIcon getIcon(int s, int par2) {
		return s == 1 ? WhiteChocolateMouldTex[0] : (s == 0 ? WhiteChocolateMouldTex[1] : WhiteChocolateMouldTex[2]);
	}
	...
	public int getRenderType() {
		return brewing.whiteChocolateBallMouldRenderID;
	}
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer player, int par6, float par7, float par8, float par9) {
		if (world.isRemote) {
			...
			if (itemstack == null) {
				...
				if (meta == 5) {
					ItemStack itemstack1 = new ItemStack(FoodRegistry.chocolateball1, 4, 3);
