...
public class BlockExtraDarkChocolateMilkCauldron extends Block {
	public static IIcon[] ExtraDarkChocolateCauldronTex;
	public static IIcon[] ExtraDarkChocolateLiquidTex;
	private int TickRate;

	public BlockExtraDarkChocolateMilkCauldron() {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister reg) {
		ExtraDarkChocolateCauldronTex = new IIcon[4];
		ExtraDarkChocolateLiquidTex = new IIcon[6];

		ExtraDarkChocolateCauldronTex[0] = reg.registerIcon("cauldron_inner");
		ExtraDarkChocolateCauldronTex[1] = reg.registerIcon("cauldron_top");
		ExtraDarkChocolateCauldronTex[2] = reg.registerIcon("cauldron_bottom");
		ExtraDarkChocolateCauldronTex[3] = reg.registerIcon("cauldron_side");


		ExtraDarkChocolateLiquidTex[5] = reg.registerIcon("killerjdog51:blockExtraDarkChocolateMilkCauldronMilkB");
		ExtraDarkChocolateLiquidTex[4] = reg.registerIcon("killerjdog51:blockExtraDarkChocolateMilkCauldronMilkA");
		ExtraDarkChocolateLiquidTex[3] = reg.registerIcon("killerjdog51:blockDarkChocolateMilkCauldronExtraDarkChocolateMilk");
		ExtraDarkChocolateLiquidTex[2] = reg.registerIcon("killerjdog51:blockDarkChocolateMilkCauldronChocolateLumpB");
		ExtraDarkChocolateLiquidTex[1] = reg.registerIcon("killerjdog51:blockDarkChocolateMilkCauldronChocolateLumpA");
		ExtraDarkChocolateLiquidTex[0] = reg.registerIcon("killerjdog51:blockChocolateMilkCauldronDarkChocolateMilk");
	...
	public IIcon getIcon(int s, int par2) {
		return s == 1 ? ExtraDarkChocolateCauldronTex[1] : (s == 0 ? ExtraDarkChocolateCauldronTex[2] : ExtraDarkChocolateCauldronTex[3]);
	}
	...
	//0 = Dark Chocolate Milk
	//1 = 1 Chocolate Lump
	//2 = 2 Chocolate Lump
	//3 = boil
	//4 = boil
	//5 = finished Extra Dark chocolate milk
		...
		if (world.isRemote) {
			...
			if (itemstack == null) {
				...
				if (itemstack.getItem() == ItemRegistry.CocoaPowder) {
					...
					if (meta == 5) {
						ItemStack itemstack1 = new ItemStack(LiquidRegistry.ExtraDarkChocolateMilkBucket, 1, 0);
					...
					if (meta == 5) {
						ItemStack itemstack1 = new ItemStack(ItemRegistry.BowlExtraDarkChocolateMilk, 1, 0);
						if (!player.inventory.addItemStackToInventory(itemstack1)) {
							world.spawnEntityInWorld(new EntityItem(world, (double) i + 0.5D, (double) j + 1.5D, (double) k + 0.5D, itemstack1));
						} else if (player instanceof EntityPlayerMP) {
							((EntityPlayerMP) player).sendContainerToPlayer(player.inventoryContainer);
