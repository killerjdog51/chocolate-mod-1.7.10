...
public class BlockExtraDarkChocolateBarMould extends Block {
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		ExtraDarkChocolateMouldTex[0] = reg.registerIcon("killerjdog51:ChocolateBarMould_top");
		...
		ExtraDarkChocolateMouldLiquidTex[0] = reg.registerIcon("killerjdog51:block_mouldextradarkchocolate");
		ExtraDarkChocolateMouldLiquidTex[1] = reg.registerIcon("killerjdog51:block_mouldextradarkchocolateready");
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer player, int par6, float par7, float par8, float par9) {
		if (world.isRemote) {
			...
			if (itemstack == null) {
				...
				if (meta == 5) {
					ItemStack itemstack1 = new ItemStack(FoodRegistry.chocolatebar1, 2, 4);
