...
public class BlockDarkChocolateBarMould extends Block {
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		DarkChocolateMouldTex[0] = reg.registerIcon("killerjdog51:ChocolateBarMould_top");
		...
		DarkChocolateMouldLiquidTex[0] = reg.registerIcon("killerjdog51:block_moulddarkchocolate");
		DarkChocolateMouldLiquidTex[1] = reg.registerIcon("killerjdog51:block_moulddarkchocolateready");
	...
	public int getRenderType() {
		return brewing.darkChocolateBarMouldRenderID;
	}
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer player, int par6, float par7, float par8, float par9) {
		if (world.isRemote) {
			...
			if (itemstack == null) {
				...
				if (meta == 5) {
					ItemStack itemstack1 = new ItemStack(FoodRegistry.chocolatebar1, 2, 1);
