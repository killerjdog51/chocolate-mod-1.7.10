...
public class BlockDarkChocolateBallMould extends Block {
	public static IIcon[] DarkChocolateMouldTex;
	public static IIcon[] DarkChocolateMouldLiquidTex;

	public BlockDarkChocolateBallMould() {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister reg) {
		DarkChocolateMouldTex = new IIcon[3];
		DarkChocolateMouldLiquidTex = new IIcon[2];

		DarkChocolateMouldTex[0] = reg.registerIcon("killerjdog51:ChocolateBallMould_top2");
		DarkChocolateMouldTex[1] = reg.registerIcon("minecraft:furnace_top");
		DarkChocolateMouldTex[2] = reg.registerIcon("minecraft:furnace_side");

		DarkChocolateMouldLiquidTex[0] = reg.registerIcon("killerjdog51:block_ballmoulddarkchocolate2");
		DarkChocolateMouldLiquidTex[1] = reg.registerIcon("killerjdog51:block_ballmoulddarkchocolateready2");
	...
	public IIcon getIcon(int s, int par2) {
		return s == 1 ? DarkChocolateMouldTex[0] : (s == 0 ? DarkChocolateMouldTex[1] : DarkChocolateMouldTex[2]);
	}
	...
	public int getRenderType() {
		return brewing.darkChocolateBallMouldRenderID;
	}
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer player, int par6, float par7, float par8, float par9) {
		if (world.isRemote) {
			...
			if (itemstack == null) {
				...
				if (meta == 5) {
					ItemStack itemstack1 = new ItemStack(FoodRegistry.chocolateball1, 4, 1);
