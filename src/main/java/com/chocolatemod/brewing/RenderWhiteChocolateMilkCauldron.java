...
public class RenderWhiteChocolateMilkCauldron implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int i, int j, int k, Block block, int modelId, RenderBlocks renderer) {
		...
		switch (meta) {
			case 0:
				icon2 = BlockWhiteChocolateMilkCauldron.WhiteChocolateLiquidTex[0];
				break;
			case 1:
				icon2 = BlockWhiteChocolateMilkCauldron.WhiteChocolateLiquidTex[1];
				break;
			case 2:
			case 3:
			case 4:
				icon2 = BlockWhiteChocolateMilkCauldron.WhiteChocolateLiquidTex[2];
				break;
			case 5:
				icon2 = BlockWhiteChocolateMilkCauldron.WhiteChocolateLiquidTex[3];
				break;
			case 6:
				icon2 = BlockWhiteChocolateMilkCauldron.WhiteChocolateLiquidTex[4];
				break;
			case 7:
			case 8:
			case 9:
				icon2 = BlockWhiteChocolateMilkCauldron.WhiteChocolateLiquidTex[5];
				break;
			case 10:
				icon2 = BlockWhiteChocolateMilkCauldron.WhiteChocolateLiquidTex[6];
				break;
			case 11:
				icon2 = BlockWhiteChocolateMilkCauldron.WhiteChocolateLiquidTex[7];
				break;
			case 12:
			case 13:
			case 14:
				icon2 = BlockWhiteChocolateMilkCauldron.WhiteChocolateLiquidTex[8];
				break;
			case 15:
				icon2 = BlockWhiteChocolateMilkCauldron.WhiteChocolateLiquidTex[9];
				break;
