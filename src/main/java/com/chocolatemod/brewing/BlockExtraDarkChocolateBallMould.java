...
public class BlockExtraDarkChocolateBallMould extends Block {
	public static IIcon[] ExtraDarkChocolateMouldTex;
	public static IIcon[] ExtraDarkChocolateMouldLiquidTex;

	public BlockExtraDarkChocolateBallMould() {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister reg) {
		ExtraDarkChocolateMouldTex = new IIcon[3];
		ExtraDarkChocolateMouldLiquidTex = new IIcon[2];

		ExtraDarkChocolateMouldTex[0] = reg.registerIcon("killerjdog51:ChocolateBallMould_top2");
		ExtraDarkChocolateMouldTex[1] = reg.registerIcon("minecraft:furnace_top");
		ExtraDarkChocolateMouldTex[2] = reg.registerIcon("minecraft:furnace_side");

		ExtraDarkChocolateMouldLiquidTex[0] = reg.registerIcon("killerjdog51:block_ballmouldextradarkchocolate2");
		ExtraDarkChocolateMouldLiquidTex[1] = reg.registerIcon("killerjdog51:block_ballmouldextradarkchocolateready2");
	...
	public IIcon getIcon(int s, int par2) {
		return s == 1 ? ExtraDarkChocolateMouldTex[0] : (s == 0 ? ExtraDarkChocolateMouldTex[1] : ExtraDarkChocolateMouldTex[2]);
	}
	...
	public Block idDropped(int par1, Random par2Random, int par3) {
		return BlockRegistry.ChocolateBallMould;
	}
	...
	public int getRenderType() {
		return brewing.ExtraDarkChocolateBallMouldRenderID;
	}
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer player, int par6, float par7, float par8, float par9) {
		if (world.isRemote) {
			...
			if (itemstack == null) {
				...
				if (meta == 5) {
					ItemStack itemstack1 = new ItemStack(FoodRegistry.chocolateball1, 4, 4);
					...
					world.setBlock(i, j, k, BlockRegistry.ChocolateBallMould);
				}
