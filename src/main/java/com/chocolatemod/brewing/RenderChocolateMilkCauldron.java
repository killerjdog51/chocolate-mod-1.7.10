...
public class RenderChocolateMilkCauldron implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int i, int j, int k, Block block, int modelId, RenderBlocks renderer) {
		...
		switch (meta) {
			case 0:
				icon2 = BlockChocolateMilkCauldron.ChocolateLiquidTex[0];
				break;
			case 1:
				icon2 = BlockChocolateMilkCauldron.ChocolateLiquidTex[1];
				break;
			case 2:
			case 3:
			case 4:
			case 5:
				icon2 = BlockChocolateMilkCauldron.ChocolateLiquidTex[2];
				break;
			case 6:
				icon2 = BlockChocolateMilkCauldron.ChocolateLiquidTex[3];
				break;
			case 7:
			case 8:
				icon2 = BlockChocolateMilkCauldron.ChocolateLiquidTex[4];
				break;
			case 9:
			case 10:
			case 11:
				icon2 = BlockChocolateMilkCauldron.ChocolateLiquidTex[5];
				break;
		}
