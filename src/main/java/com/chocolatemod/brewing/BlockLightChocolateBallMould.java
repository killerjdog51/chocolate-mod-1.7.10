...
public class BlockLightChocolateBallMould extends Block {
	public static IIcon[] LightChocolateMouldTex;
	public static IIcon[] LightChocolateMouldLiquidTex;

	public BlockLightChocolateBallMould() {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		LightChocolateMouldTex[0] = reg.registerIcon("killerjdog51:ChocolateBallMould_top2");
		...
		LightChocolateMouldLiquidTex[0] = reg.registerIcon("killerjdog51:block_ballmouldlightchocolate2");
		LightChocolateMouldLiquidTex[1] = reg.registerIcon("killerjdog51:block_ballmouldlightchocolateready2");
	...
	public int getRenderType() {
		return brewing.lightChocolateBallMouldRenderID;
	}
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer player, int par6, float par7, float par8, float par9) {
		if (world.isRemote) {
			...
			if (itemstack == null) {
				...
				if (meta == 5) {
					ItemStack itemstack1 = new ItemStack(FoodRegistry.chocolateball1, 4, 2);
