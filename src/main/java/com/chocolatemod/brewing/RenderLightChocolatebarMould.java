...
public class RenderLightChocolatebarMould implements ISimpleBlockRenderingHandler {
	@Override
	...
	public boolean renderWorldBlock(IBlockAccess world, int i, int j, int k, Block block, int modelId, RenderBlocks renderer) {
		...
		IIcon icon1 = BlockLightChocolateBarMould.LightChocolateMouldTex[0];
		...
		IIcon icon2 = BlockLightChocolateBarMould.LightChocolateMouldLiquidTex[0];
		...
		switch (meta) {
			...
			case 3:
			case 4:
				icon2 = BlockLightChocolateBarMould.LightChocolateMouldLiquidTex[0];
				break;
			case 5:
				icon2 = BlockLightChocolateBarMould.LightChocolateMouldLiquidTex[1];
				break;
