...
public class BucketExtraDarkChocolateMilk extends ItemBucket {

	public BucketExtraDarkChocolateMilk(Block p_i45331_1_) {
		super(LiquidRegistry.ExtraDarkChocolateMilkBlock);
	...
	public ItemStack onEaten(ItemStack p_77654_1_, World p_77654_2_, EntityPlayer p_77654_3_) {
		...
		if (!p_77654_2_.isRemote) {
			p_77654_3_.getFoodStats().addStats(2, .8F);
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par3EntityPlayer, World par2World, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_) {
		...
		par2World.setBlock(X, Y, Z, LiquidRegistry.ExtraDarkChocolateMilkBlock);

		if (!par3EntityPlayer.capabilities.isCreativeMode) {
			par3EntityPlayer.inventory.consumeInventoryItem(LiquidRegistry.ExtraDarkChocolateMilkBucket);
